...
function FilterIcon() {
    return(
        <svg xmlns="http://www.w3.org/2000/svg" class="ionicon" viewBox="0 0 512 512">
            <path fill="#fff3e4" stroke="tomato" stroke-width="32" stroke-miterlimit="10" d="M448 256c0-106-86-192-192-192S64 150 64 256s86 192 192 192 192-86 192-192z"/>
...
export { LeftArrowIcon, RightArrowIcon, UpDownArrowIcon, EyeIcon, 
    FilmIcon, TvIcon, MagnifyerIcon, MagnifyerButtonIcon, InfoIcon, FilterIcon 
}
