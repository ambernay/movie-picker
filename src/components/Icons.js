...
function TvIcon() {
    return (
        <svg className="ionicon" viewBox="16 80 480 336">
            ...
            <path strokeLinecap="round" strokeMiterlimit="10" strokeWidth="35" d="M128 416h256" />
        </svg>
    )

    // return (<svg classname="ionicon" viewBox="16 80 480 336"><path d="M447.86 384H64.14A48.2 48.2 0 0116 335.86V128.14A48.2 48.2 0 0164.14 80h383.72A48.2 48.2 0 01496 128.14v207.72A48.2 48.2 0 01447.86 384z"></path><path strokelinecap="round" strokemiterlimit="10" strokewidth="32" d="M128 416h256"></path></svg>)
}
