function ToggleButton({ tvMovieToggle, setTvMovieToggle }) {
    ...
    return (
        <figure id={tvMovieToggle === 'movie' ? "movie-option" : "tv-option"} className="toggle-button-container" onClick={handleTvMovieToggle}>
            <span className="slider"></span>
            <figure id={tvMovieToggle === 'movie' ? "activated-option" : "deactivated-option"} className="toggle-left movie-icon">
            ...
            <figure id={tvMovieToggle === 'tv' ? "activated-option" : "deactivated-option"} className="toggle-right tv-icon">
            ...
            <figcaption className="sr-only">Movie vs TV toggle switch</figcaption>
        </figure>
    )
};
